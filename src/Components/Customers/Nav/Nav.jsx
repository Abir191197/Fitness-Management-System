              ...
              <ul className="flex flex-col py-4 space-y-1">
                ...
                <li>
                  <a
                    ...
                    <span className="ml-2 text-sm tracking-wide truncate">
                      <Link to="/classes/Overview">Dashboard</Link>
                    </span>
                  </a>
                </li>
                <li>
                  <a
                    ...
                    <span className="ml-2 text-sm tracking-wide truncate">
                      <Link to="/Classes/Inbox">Nutritionist Guideline </Link>
                    </span>
                  </a>
                </li>
                <li>
                  <a
                    ...
                    <span className="ml-2 text-sm tracking-wide truncate">
                      <Link to="/Classes/ExerciseListProvideTrainer">
                        Trainer Guideline
                      </Link>
                    </span>
                  </a>
                ...
                <li>
                  <a
                    ...
                    <span className="ml-2 text-sm tracking-wide truncate">
                      <Link to="/classes/Blog">Blog</Link>
                    </span>
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a
                    ...
                    <span className="ml-2 text-sm tracking-wide truncate">
                      <Link to="/Classes/Food">Food List Form </Link>
                    </span>
                  </a>
                </li>
                <li>
                  <a
                    ...
                    <span className="ml-2 text-sm tracking-wide truncate">
                      <Link to="/Classes/Exercise">Exercise Form</Link>
                    </span>
          ...
          <div className="relative  h-[500px] w-44  bg-gray-600 rounded-md ">
            <div className="absolute border   rounded-md inset-y-0 left-0 w-44 p-6">
              <ul>
                ...
                <button className=" h-[50px] w-[100px] bg-orange-400  mt-8 hover:bg-orange-700  border border-amber-800 rounded-md ">
                  <Link to="/Classes/Report">Report</Link>
                </button>
              </ul>
            </div>
          </div>
